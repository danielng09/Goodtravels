Activity.create!([
  {title: "Golden Gate Bridge", location: "Golden Gate Bridge\\nCalifornia", description: "The Golden Gate Bridge is a suspension bridge spanning the Golden Gate strait, the mile-wide, three-mile-long channel between San Francisco Bay and the Pacific Ocean. The bridge is one of the most internationally recognized symbols of San Francisco, California, and the United States. It has been declared one of the Wonders of the Modern World by the American Society of Civil Engineers.", image_url: "http://res.cloudinary.com/ds6oys8ca/image/upload/c_scale,w_700/v1436417610/GoldenGateBridge-001_wihw07.jpg", lng: -122.4786, lat: 37.8197},
