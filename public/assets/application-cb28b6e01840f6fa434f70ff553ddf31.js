...
(function() { this.JST || (this.JST = {}); this.JST["activities/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'search-bar\'>Search</div>\n\n<h1 class=\'text-center\' id=\'activity-title\'>Activities</h1>\n<br>\n\n<div class="activities col-md-10 col-md-offset-1"></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["activities/indexItem"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class= \'activities-index-pictures\' style=\n  \'',  'background-image: url(' + this.model.escape('image_url') + ');' ,'\'>\n</div>\n\n<h4 class=\'index-item\'>',  activity.escape('title') ,'</h5>\n<div class="index-item-stars"></div>\n<p class="review-count">',  activity.get('review_count') ,'\n  ',  activity.get('review_count') === 1 ? 'review' : 'reviews' ,'</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["activities/search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="search-form col-md-3">\n  <div class=\'input-group\'>\n    <div class="input-group-addon">Find</div>\n    <input type="text" class="form-control" placeholder="exploratorium" name="searchParams">\n  </div>\n</div>\n  <button type=\'submit\' class=\'btn btn-primary search-button\' value=\'search\' aria-label="Left Align">\n    <span class="glyphicon glyphicon-search" aria-hidden="true"></span>\n  </button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["activities/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'activity-details col-md-10 col-md-offset-1\'></div>\n\n<div class="activity-reviews col-md-10 col-md-offset-1">\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["activities/showDetails"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div>\n  <div class="activity-picture-container" style=\n    "',  'background: url(' + activity.escape('image_url') + ');' ,'">\n  </div>\n\n  <div class="activity-information">\n    <p class=\'activitity-detail-name\'>',  activity.escape('title') ,'</p>\n\n    <p class=\'address\'>');  activity.escape('location').split(/\\n/).forEach(function(adLine) { ; __p.push('\n      ',  adLine ,'<br>\n    ');  }) ; __p.push('</p>\n\n    <p>',  activity.escape('description') ,'</p>\n    <p class="activity-detail-reviews">',  activity.get('review_count') ,'\n      ',  activity.get('review_count') === 1 ? 'review' : 'reviews' ,'</p>\n\n    <div class=\'activity-detail-stars\'></div>\n    <br>\n\n    <button type="button" class="want-button btn btn-success">\n      Want to do\n    </button>\n\n    <button type="button" class=\'new-review-button btn btn-success\'>\n      Write a Review\n    </button>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/form"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="m-backdrop"></div>\n<div class="m-content">\n  <button class="close">&times;</button>\n    <h3>New Review</h3>\n  <form class="new-review">\n    Description:<br>\n    <textarea class="form-control" rows="4" name="review[body]"></textarea>\n    <br>\n\n    Rating:<br>\n    <div class=\'new-review-stars\'></div>\n    <input type="hidden" id="rating-value" name="review[rating]" value="0">\n\n    <input type=\'submit\' class=\'new-review btn btn-primary\' value=\'submit\'>\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class= \'avatar-thumb\' style=\n  \'',  'background-image: url(' + user.get('image_url') + ');' ,'\'>\n</div>\n\n<p>Written by <a href="',  '#/users/' + user.get('id') ,'">',  user.get('username') ,'</a></p>\n<p>Posted on ',  review.get('created_at') ,'</p>\n<p>Rating: <div class=\'user-star-rating\'></div></p>\n<p>Description: ',  review.escape('body') ,'</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'users-index\'></div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/indexItem"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="',  '#/users/' + user.id ,'">\n  ',  user.get('username') ,'\n</a>\n\n<p>member since ',  user.get('created_at') ,'</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'user-details col-md-10 col-md-offset-1\'>\n  <img class="avatar" src="',  user.get('image_url') ,'"</img>\n  <p class=\'username\'>',  user.get('username') ,'</p>\n  <p>Member since ',  user.get('created_at') ,'</p>\n  ');  if (user.get('current_user')) { ; __p.push('\n    <button type=\'button\' class=\'btn btn-primary\'>Upload Avatar</button>\n  ');  } ; __p.push('\n</div>\n\n<div class="user-reviews col-md-10 col-md-offset-1">\n  <h4>Reviews</h4>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/showItem"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  review.get('activity_id') ,'\n<br>\n',  review.get('body') ,'\n<br>\nRating: ',  review.get('rating') ,'\n\n<p>Reviewed on ',  review.get('created_at') ,'</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/wants"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1 class=\'text-center\'>Want To Dos</h1>\n<br>\n<div class="want-list col-md-10 col-md-offset-1"></div>\n');}return __p.join('');};
}).call(this);
...
Goodtravels.Collections.Wants = Backbone.Collection.extend({
  url: '/api/wants',
  model: Goodtravels.Models.Want
});
